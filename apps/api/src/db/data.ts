...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    tags: ["Palestra de Encerramento", "40 anos de produção: uma aventura com muitos destinos"],
  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        description: "40 anos de produção: uma aventura com muitos destinos",
        speaker: "Ligia Walper, cineasta (Walper Ruas Produções)",
        location: "Auditório do Bloco H",
        kind: "keynote",
      },
    ],
