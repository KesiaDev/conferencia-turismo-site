        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg border-4 border-white h-[450px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3484.4976548975697!2d-51.17899!3d-29.16833!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x951eadf5a7e0e5d5%3A0x5c2b0c0c0c0c0c0c!2sUniversidade%20de%20Caxias%20do%20Sul%20-%20UCS!5e0!3m2!1spt-BR!2sbr!4v1704067200000!5m2!1spt-BR!2sbr"
              ...
              <div className="mt-4 text-center">
                <p className="text-sm text-gray-600 mb-2">
                  Se o mapa não carregar, você pode acessar diretamente:
                </p>
                <a
                  href="https://maps.google.com/maps?q=Universidade+de+Caxias+do+Sul,+Rua+Francisco+Getúlio+Vargas,+1130,+Caxias+do+Sul,+RS,+Brasil"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-2 bg-[#e0a085] text-white rounded-lg hover:bg-[#d49070] transition-colors"
                >
