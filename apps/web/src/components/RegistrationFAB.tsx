...
export default function RegistrationFAB() {
  ...
  return (
    <Link
      to="/fees"
      className="fixed bottom-6 right-6 z-50 hidden md:flex flex-col items-center gap-0.5 rounded-xl px-4 py-3 shadow-lg transition hover:scale-105 hover:shadow-xl"
